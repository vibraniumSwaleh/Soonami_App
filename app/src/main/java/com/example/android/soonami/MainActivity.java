    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        protected Event doInBackground(URL... urls) {
            ...
            try {
                ...
                Log.e(LOG_TAG, "Url was not able to be created", e);
            }
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            //if url in empty return empty jsonResponse string
            ...
            try {
                ...
                //get response if connection is successful (200)
                ...
                Log.e(LOG_TAG, "Connection not established, error response code: " + urlConnection.getResponseCode(), e);
            } finally {
        ...
        private Event extractFeatureFromJson(String earthquakeJSON) {
            ...
            //return null or exit method if input string (earthquakeJSON) is empty
